    ...
    return (
        <>
                        ...
                        <div className="col-md-8">
                            <div className="top-bar-left">
                                ...
                                <div className="text">
                                    ...
                                    <a href="tel:+91-9992991259"><p>+91-9992991259</p></a>
                                </div>
                                <div className="text">
                                    <i className="fa fa-envelope"></i>
                                    <a href="mailto:raysofhopesrmap@gmail.com"><p>raysofhopesrmap@gmail.com</p></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="top-bar-right">
                                <div className="social">
                                    <a href="https://x.com/SRMUAP?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"><i className="fab fa-x-twitter"></i></a>
                                    <a href="https://www.facebook.com/SRMUAP/"><i className="fab fa-facebook-f"></i></a>
                                    <a href="https://www.instagram.com/srmuap/?hl=en"><i className="fab fa-instagram"></i></a>
                                    <a href="https://www.youtube.com/c/SRMUniversityAP"><i className="fab fa-youtube"></i></a>
                                    <a href="https://www.linkedin.com/school/srmuap/posts/?feedView=all"><i className="fab fa-linkedin-in"></i></a>
                                </div>
            ...
            <div className="navbar navbar-expand-lg bg-dark navbar-dark">
                <div className="container-fluid">
                    <Link to="/" className="navbar-brand">Rays of Hope</Link>
